 ...
 */
package com.aidt.oauth.server.test.config;

import java.util.UUID;

import com.aidt.oauth.server.test.authentication.DeviceClientAuthenticationProvider;
import com.aidt.oauth.server.test.federation.FederatedIdentityIdTokenCustomizer;
import com.aidt.oauth.server.test.jose.Jwks;
import com.aidt.oauth.server.test.web.authentication.DeviceClientAuthenticationConverter;
